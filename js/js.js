...
function updateHtmlOutput(selectedFont = fontMap["en"]) {
  ...
  if (isForEmail) {
    finalHtml = `
<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td bgcolor="#ffffff" class="mobile-side-padding-20 mobile-top-padding-20" style="${selectedFont}; font-size: 16px; line-height: 24px; mso-line-height-rule: exactly; color: #000000; padding: 20px 30px; text-align: left;">${innerHtml}</td></tr></tbody></table>
`;
  } else {
    finalHtml = `
